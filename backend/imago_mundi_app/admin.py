...
class ImagoMundiResource(resources.ModelResource):
    # attribute is name in model, Columnname is the one of import
    ...
    def before_import_row(self, row, **kwargs):
        ...
        # split place of origin in two columns. In before_import method already there are these extra columns inserted
